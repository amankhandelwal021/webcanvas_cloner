      ...
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-16">
          ...
          <div className="md:col-span-1">
            <a href="#home" className="text-2xl font-display font-bold tracking-tight mb-6 inline-block text-white">
            ...
            <div className="flex space-x-4">
              {['facebook', 'twitter', 'instagram', 'linkedin'].map((social) => (
                <a 
                  ...
                  className="w-10 h-10 rounded-full bg-indigo-900/60 flex items-center justify-center hover:bg-blue-600 transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <a href="mailto:hello@designowe.com" className="text-gray-300 hover:text-white transition-colors text-sm">
                  hello@designowe.com
                </a>
              </li>
              <li className="flex items-start">
        ...
        {/* Bottom bar */}
        <div className="pt-8 mt-8 border-t border-indigo-900/50 flex flex-col md:flex-row justify-between items-center">
