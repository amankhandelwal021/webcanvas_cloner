...
const ServiceCard = ({ title, description, icon, delay, id }: ServiceCardProps) => {
  ...
  return (
    ...
    >
      <div className="mb-6 p-3 rounded-xl bg-blue-50 dark:bg-blue-900/30 w-12 h-12 flex items-center justify-center text-blue-600 dark:text-blue-300 transition-transform duration-300 group-hover:scale-110">
        {icon}
      </div>
      ...
      <Link
        to={`/services/${id}`}
        className="inline-flex items-center text-blue-600 dark:text-blue-300 font-medium hover:text-blue-700 dark:hover:text-blue-200 transition-colors"
      >
